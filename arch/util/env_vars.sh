...
# And another point to pay attention to is, $HOME will change to "/root",
# which is different from Ubuntu.
...
export USER_DOWNLOADS=$USER_HOME/Downloads
export USER_FONTS_DIR=$USER_HOME/.fonts

export USER_ROOM=$USER_HOME/bedroom
