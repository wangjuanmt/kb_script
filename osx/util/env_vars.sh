...
# Although $USER will change to "root",
...
export TARGET_USER_GROUP=staff
export USER_HOME=/Users/$TARGET_USER
export USER_DOWNLOADS=$HOME/Downloads
export USER_FONTS_DIR=$HOME/Library/Fonts
...
export SYSTEM_ID=osx

export SYSTEM_CATEGORY=mac
